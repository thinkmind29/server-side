...
exports.facebookUser = function (user, callback) {
    _user2.default.findOne({ facebookId: user.id }).then(function (person) {
        if (person) callback({ status: 200, message: person.token });
    });
};
